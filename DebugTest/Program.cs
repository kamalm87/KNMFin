...
namespace DebugTest
{
    ...
    class Program
    {
        ...
        static void Main( string [] args )
        {
            ...
            // Queries all of the Industries in the Finanical sector
            var industryQ = Aggregates.Industries( Industry.All.ToList<Industry>( ) );

            // Gets every available company name
            KNMFinExcel.Yahoo.ExcelYahoo.GetCompanyInfo( OutputDir + CreateNamedOutputFile( "company names", ".xlsx" ), industryQ );
