...
namespace DebugTest
{
    static class TestYahoo
    {
        ...
        {
            var tickersToQuery = new string [] { "aapl", "bac", "gs", "mcd", "sbux", "mmm", "t", "v", "flws" };
            var quoteProprties = new QuoteProperties[]{QuoteProperties.Name, QuoteProperties.MarketCapitalization, QuoteProperties.EBITDA, QuoteProperties.PERatio };

            return KNMFin.Yahoo.CompanyQuote.Quote.GetCompanyQuotes( tickersToQuery.ToList<string>(), quoteProprties );
        }
