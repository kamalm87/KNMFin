...
namespace KNMFin.Yahoo
{
    namespace Quotes
    {
        ...
        public sealed class QuoteProperties
        {
            ...
            public static readonly QuoteProperties AfterHoursChangeRealtime = new QuoteProperties( 1, "c8", "After Hours Change (Realtime)", ResultType.Range );
            ...
            public static readonly QuoteProperties Change = new QuoteProperties( 11, "c1", "Change", ResultType.Percentage );
            public static readonly QuoteProperties Change_ChangeInPercent = new QuoteProperties( 12, "c0", "Change Change In Percent", ResultType.RangePercentage );
            public static readonly QuoteProperties ChangeFromFiftydayMovingAverage = new QuoteProperties( 13, "m7", "Change From Fiftyday Moving Average", ResultType.Percentage  );
            public static readonly QuoteProperties ChangeFromTwoHundreddayMovingAverage = new QuoteProperties( 14, "m5", "Change From Two Hundredday Moving Average", ResultType.Percentage );
            public static readonly QuoteProperties ChangeFromYearHigh = new QuoteProperties( 15, "k4", "Change From Year High", ResultType.Percentage );
            public static readonly QuoteProperties ChangeFromYearLow = new QuoteProperties( 16, "j5", "Change From Year Low", ResultType.Percentage );
            public static readonly QuoteProperties ChangeInPercent = new QuoteProperties( 17, "p2", "Change In Percent", ResultType.Percentage );
            public static readonly QuoteProperties ChangeInPercentRealtime = new QuoteProperties( 18, "k2", "Change In Percent (Realtime)", ResultType.RangePercentage );
            public static readonly QuoteProperties ChangeRealtime = new QuoteProperties( 19, "c6", "Change (Realtime)", ResultType.Percentage );
            public static readonly QuoteProperties Commission = new QuoteProperties( 20, "c3", "Commission" );

            public static readonly QuoteProperties Currency = new QuoteProperties( 21, "c4", "Currency", ResultType.Text );
            ...
            public static readonly QuoteProperties DaysRange = new QuoteProperties( 24, "m0", "Days Range", ResultType.Range);
            public static readonly QuoteProperties DaysRangeRealtime = new QuoteProperties( 25, "m2", "Days Range (Realtime)", ResultType.Range );
            public static readonly QuoteProperties DaysValueChange = new QuoteProperties( 26, "w1", "Days Value Change", ResultType.Range);
            public static readonly QuoteProperties DaysValueChangeRealtime = new QuoteProperties( 27, "w4", "Days Value Change (Realtime)", ResultType.Range );
            public static readonly QuoteProperties DividendPayDate = new QuoteProperties( 28, "r1", "Dividend Pay Date", ResultType.Date );
            ...
            public static readonly QuoteProperties TrailingAnnualDividendYieldInPercent = new QuoteProperties( 30, "y0", "Trailing Annual Dividend Yield In Percent", ResultType.Percentage );

            public static readonly QuoteProperties DilutedEPS = new QuoteProperties( 31, "e0", "Diluted E P S" );
            public static readonly QuoteProperties EBITDA = new QuoteProperties( 32, "j4", "E B I T D A", ResultType.TruncuatedCurrency );
            ...
            public static readonly QuoteProperties ExDividendDate = new QuoteProperties( 36, "q0", "Ex Dividend Date", ResultType.Date );
            ...
            public static readonly QuoteProperties HoldingsGainPercent = new QuoteProperties( 41, "g1", "Holdings Gain Percent", ResultType.Percentage );
            public static readonly QuoteProperties HoldingsGainPercentRealtime = new QuoteProperties( 42, "g5", "Holdings Gain Percent (Realtime)", ResultType.RangePercentage );
            ...
            public static readonly QuoteProperties LastTradeDate = new QuoteProperties( 46, "d1", "Last Trade Date", ResultType.Date );
            public static readonly QuoteProperties LastTradePriceOnly = new QuoteProperties( 47, "l1", "Last Trade Price Only" );
            public static readonly QuoteProperties LastTradeRealtimeWithTime = new QuoteProperties( 48, "k1", "Last Trade (Realtime) With Time", ResultType.Pair  );
            public static readonly QuoteProperties LastTradeSize = new QuoteProperties( 49, "k3", "Last Trade Size" );
            public static readonly QuoteProperties LastTradeTime = new QuoteProperties( 50, "t1", "Last Trade Time", ResultType.Date );

            public static readonly QuoteProperties LastTradeWithTime = new QuoteProperties( 51, "l0", "Last Trade With Time", ResultType.Pair );
            public static readonly QuoteProperties LowLimit = new QuoteProperties( 52, "l3", "Low Limit" );
            public static readonly QuoteProperties MarketCapitalization = new QuoteProperties( 53, "j1", "Market Capitalization", ResultType.TruncuatedCurrency );
            public static readonly QuoteProperties MarketCapRealtime = new QuoteProperties( 54, "j3", "Market Cap (Realtime)", ResultType.TruncuatedCurrency );
            public static readonly QuoteProperties MoreInfo = new QuoteProperties( 55, "i0", "More Info", ResultType.Text );
            public static readonly QuoteProperties Name = new QuoteProperties( 56, "n0", "Name", ResultType.Text );
            public static readonly QuoteProperties Notes = new QuoteProperties( 57, "n4", "Notes", ResultType.Text);
            ...
            public static readonly QuoteProperties PercentChangeFromFiftydayMovingAverage = new QuoteProperties( 64, "m8", "Percent Change From Fiftyday Moving Average", ResultType.Percentage );
            public static readonly QuoteProperties PercentChangeFromTwoHundreddayMovingAverage = new QuoteProperties( 65, "m6", "Percent Change From Two Hundredday Moving Average", ResultType.Percentage );
            public static readonly QuoteProperties ChangeInPercentFromYearHigh = new QuoteProperties( 66, "k5", "Change In Percent From Year High", ResultType.Percentage );
            public static readonly QuoteProperties PercentChangeFromYearLow = new QuoteProperties( 67, "j6", "Percent Change From Year Low", ResultType.Percentage );
            ...
            public static readonly QuoteProperties Revenue = new QuoteProperties( 74, "s6", "Revenue", ResultType.TruncuatedCurrency );
            
            public static readonly QuoteProperties ShortRatio = new QuoteProperties( 77, "s7", "Short Ratio" );
            public static readonly QuoteProperties StockExchange = new QuoteProperties( 78, "x0", "Stock Exchange", ResultType.Text );
            public static readonly QuoteProperties Symbol = new QuoteProperties( 79, "s0", "Symbol", ResultType.Text );  
            public static readonly QuoteProperties TickerTrend = new QuoteProperties( 80, "t7", "Ticker Trend", ResultType.Text );

            public static readonly QuoteProperties TradeDate = new QuoteProperties( 81, "d2", "Trade Date", ResultType.Date );
            ...
            public static readonly QuoteProperties YearRange = new QuoteProperties( 88, "w0", "Year Range", ResultType.Range );
            ...
            // 38 - Shares Float
             ...
             // 82 - Trade Links
             public static readonly QuoteProperties TradeLinks = new QuoteProperties( 82, "t6", "Trade Links", ResultType.Text );
             // 83 - Trade Links Additional
             public static readonly QuoteProperties TradeLinksAdditional = new QuoteProperties( 83, "f0", "Trade Links Additional", ResultType.Text );

            // These will be skipped
            public static HashSet<QuoteProperties> _SpecialCases = new HashSet<QuoteProperties> { AskSize, AnnualizedGain, AfterHoursChangeRealtime, SharesFloat, LastTradeSize, SharesOwned, SharesOutstanding, TradeLinks, TradeLinksAdditional, Name, BidSize };
            ...
            private QuoteProperties( int value, string name, string desription, ResultType Type = ResultType.Number )
            {
