...
namespace KNMFin
{
    namespace Yahoo
    {
        ...
        public enum ReturnCalculations
        {
            None = 0,
            Close = 1,
            AdjClose = 2,
        ...
        namespace Return
        {
            public class HistoricalQuoteResult
            {
                StockPrice StockPriceData;
                List<Tuple<ReturnCalculations, List<StockReturn>>> Returns;
            }
            ...
            public class StockPrice
            {
                DateTime BegDate;
                DateTime EndDate;
                List<KNMFin.Yahoo.HistoricalQuotes.ReturnRow> Data;
            }
